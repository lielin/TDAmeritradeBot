...
class Portfolio:
    ...
    # Initial values for portfolio
    def __init__(self, account_number: Optional[str]):
        self.positions = {}  # Houses all positions
        self.positions_count = 0
        self.market_value = 0.0
        self.profit_loss = 0.0
        self.risk_tolerance = 0.0  # Risk tolerance for trading portfolio
        self.account_number = account_number  # Used for API calls

    # User adds one position
    def add_position(self, symbol: str, asset_type: str, purchase_date: Optional[str], quantity: int = 0,
                     purchase_price: float = 0.0) -> dict:
        # Call positions dictionary
        # Add a key to it (symbol)
        # Dictionary is associated with key (Nested dictionary)
        ...
        # Return position dict back to user
        return self.positions

    # User adds multiple position at once
    # MUST pass through as dictionary
