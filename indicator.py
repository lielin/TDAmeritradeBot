...
class Indicators():
    ...
    def set_indicator_signals(self, indicator: str, buy: float, sell: float, condition_buy: Any, condition_sell: Any) \
            -> None:
        # If there's no signal for indicator, set a template
    ...
    def rsi(self, period: int, method: str = 'wilders') -> pd.DataFrame:
        ...
        # Add the RSI indicator ot the data frame
